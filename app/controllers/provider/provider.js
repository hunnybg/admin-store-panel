                                                            ...
                                                            Provider.findOne({referral_code: request_data_body.referral_code}).then((provider) => {
                                                                ...
                                                                if (provider) {
                                                                    ...
                                                                    if (provider_refferal_count < country.no_of_provider_use_referral) {
                                                                        ...
                                                                        // Entry in wallet Table //
                                                                        var new_total_wallet_amount = wallet_history.add_wallet_history(ADMIN_DATA_ID.USER, provider_data.unique_id, provider_data._id, provider_data.country_id, wallet_currency_code, wallet_currency_code,
            ...
            Provider.findOne({_id: request_data_body.provider_id}).then((provider) => {
                if (provider) {
                    ...
                    } else
                    {
                        ...
                        Request.aggregate([provider_condition, delivery_status_condition, delivery_status_manage_id_condition, filter,
                            {
                                $lookup:
                                    {
                                        from: "users",
