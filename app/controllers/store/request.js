                                                            ...
                                                            if (order_payment) {
                                                                ...
                                                                //     }
                                                                    ...
                                                                    Payment_gateway.findOne({_id: order_payment.payment_id}).then((payment_gateway) => {
                                                                        ...
                                                                        if (store && ((setting_detail.is_store_earning_add_in_wallet_on_cash_payment && is_store_earning_add_in_wallet_on_cash_payment_for_city) || (setting_detail.is_store_earning_add_in_wallet_on_other_payment && is_store_earning_add_in_wallet_on_other_payment_for_city)))
                                                                        {
                                                                            if (pay_to_store<0) {
