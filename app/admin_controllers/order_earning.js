...
exports.get_order_earning = function (request_data, response_data) {
    utils.check_request_params(request_data.body, [], function (response) {
        if (response.success) {
            ...
            Order.aggregate([order_status_id_condition, user_query, order_payment_query, store_query,city_query,country_query, array_to_json_user_detail, array_to_json_store_detail, array_to_json_order_payment_query, payment_gateway_query,  array_to_json_city_detail, array_to_json_country_query, request_query, array_to_json_request_query, provider_query
                , search
                , filter
                , count
            ]).then((orders) => {
