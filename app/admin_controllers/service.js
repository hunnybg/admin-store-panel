    ...
    utils.check_request_params(request_data.body, [], function (response) {
        if (response.success) {
            ...
            Service.findOneAndUpdate({_id: request_data_body.service_id}, {is_default: request_data_body.is_default}, function(error, service_data){
                Service.update({type_id: request_data_body.type_id, delivery_type: request_data_body.delivery_type, city_id: request_data_body.city_id, _id: {$ne: request_data_body.service_id}}, {is_default: false}, function(error, service_list){
