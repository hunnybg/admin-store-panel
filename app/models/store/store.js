...
var store = new schema({
    ...
    store_owner_id: { type: schema.Types.ObjectId },
    store_unique_code: {type: String, default: ""},
    beacon_id: {type: String, default: ""},
    // STORE INFORMATION
    ...
    features_available: {type: Array, default: [1]},
    ...
    //Auto Transfer
    auto_transfer: {type: Boolean, default: false},
    time_of_transfer : {type: String, default: ""},
