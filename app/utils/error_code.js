...
exports = STORE_ERROR_CODE = {
    ...
    STORE_WITHDRAW_EARNING_FAILED: 648,
    NO_TRANSFERRED_HISTORY_FOUND: 649

};


exports = VAITER_ERROR_CODE = {
    REGISTRATION_FAILED: 401,
    EMAIL_ALREADY_REGISTRED: 402,
    PHONE_NUMBER_ALREADY_REGISTRED: 403,
    VAITER_ALREADY_REGISTER_WITH_SOCIAL: 405,
    VAITER_NOT_REGISTER_WITH_SOCIAL: 406,
    LOGIN_FAILED: 411,
    ...
    LOGOUT_FAILED: 423,
    VAITER_DATA_NOT_FOUND: 424,
    STATUS_CHANGE_FAILED: 425,
    NO_VAITER_FOUND: 426,
    VAITER_NOT_FOUND_SELECTED_SERVICE: 426,
    ...
    VAITER_VEHICLE_ADD_FAILED: 434,
    VAITER_VEHICLE_UPDATE_FAILED: 435,
    VAITER_VEHICLE_LIST_NOT_FOUND: 436,
    ...
    NOT_AUTHORIZED: 1995,
    INVALID_DATE: 1996,
    NO_MONTHLY_SHIFTS_FOUND : 1997,
    NO_SHIFTS_FOUND_ON_THIS_DAY : 1998,
    SHIFT_TIME_UPDATE_FAILED : 1999,
    DELETE_SHIFT_FAILED : 2090,
    SHEDULE_EMAIL_SENT_FAILED : 2091
};
...
exports = ORDER_ERROR_CODE = {
    ...
    ORDER_CANCEL_OR_REJECT_BY_VAITER_FAILED: 657,
    ...
    ORDER_ALREADY_IN_PROCESS: 663,
    ORDER_ALREADY_MADE: 664,
    INVALID_ORDER_STATE: 665,
    ORDER_MADE_REMAINING: 666,
    THIS_ORDER_CANNOT_BE_CANCELLED : 667,
    THIS_ORDER_CANCEL_CANNOT_BE_RJECTED : 668,

    TIP_PAYMENT_FAILED : 669,
    NO_ORDERS_FOUND : 670
...
exports = REQUEST_ASSISTANCE_ERROR_CODE = {
    NO_REQUEST_ASSISTANCE_FOUND: 2063,
    REQUEST_ALREADY_RESOLVED: 2064,
    REQUEST_ALREADY_CREATED : 2065
}


exports = TABLE_REQUEST_ERROR_CODE = {
    NO_TABLE_REQUEST_FOUND: 2080,
    REQUEST_ALREADY_RESOLVED: 2081
}

exports = TICKET_ERROR_CODE = {
    NO_TICKET_FOUND: 2190,
    TICKET_ALREADY_RESOLVED: 2191
}