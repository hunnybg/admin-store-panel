...
import {ERROR_CODE_CONSTANT, WALLET_COMMENT_ID, DELIVERY_TYPE, CONSTANT, ADMIN_DATA_ID, ORDER_STATE, NEW_ORDER_STATE, ADMIN_PROFIT_ON_ORDER_ID, ADMIN_PROFIT_ON_ORDER_STRING, WEEK, MONTH, DAY ,DATE_FORMAT, TIMEOUT, ADMIN_PROMO_FOR_ID, PROMO_RECURSION_ID, PROMO_RECURSION_STRING, PROMO_RECURSION ,WALLET_REQUEST_STATUS, ORDER_STATUS_ID,ADMIN_PROFIT_ON_DELIVERYS,ADMIN_PROFIT_ON_ORDERS,ADMIN_IMAGE_TYPES,ADMIN_PROMO_FOR_DELIVERY_SERVICE,ADMIN_PROMO_FOR,ADMIN_IMAGE_RATIO,ADMIN_URL , VAITER_TYPES , ORDER_FEATURE_TYPE} from "../constant";
import {TranslateService} from 'ng2-translate';


import {title, button,heading_title , status ,wallet_request_status, message ,tooltip_title,sub_menu_title, menu_title,setting_tab_title} from './admin/admin_panel_string';
...
export class Helper {
    ...
    public ADMIN_PROMO_FOR_DELIVERY_SERVICE : any = ADMIN_PROMO_FOR_DELIVERY_SERVICE;
